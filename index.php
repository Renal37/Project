...
<section class="text-gray-600 body-font">
  <div class="docPanel">
    <form class="bg-gray-100 rounded-lg p-8 flex flex-col mt-10" action="" method="post"  enctype="multipart/form-data">
      ...
      <div class="relative mb-4">
        <label for="file" name='btn' class="leading-7 text-sm text-gray-600">Выбрать изображение</label>
        <input type="file" name="file" id="file" required class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
      </div>
